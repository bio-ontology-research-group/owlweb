    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('topics', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=127),
                                                                     blank=True, null=True, size=None)),
                ('species', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=127),
                                                                      blank=True, null=True, size=None)),
                ('status', models.CharField(choices=[('Classified', 'Classified'), ('Unloadable', 'Unloadable'),
                                                     ('Incoherent', 'Incoherent'), ('Unknown', 'Unknown')],
                                            default='Unknown', max_length=31)),
                ...
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                                 related_name='created_ontologies', to=settings.AUTH_USER_MODEL)),
                ('modified_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                                  related_name='modified_ontologies', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
