...
def test_create_ontology():
    ...
    assert not ontology.is_obsolete
...
def test_create_submission():
    ...
    # when
    submission = Submission.objects.create(submission_id="1", ontology=ontologyRef, domain="biology",
                                           description="some desc",
                                           date_released=date_str, date_created=date_str, version="1.0", nb_classes=100,
                                           indexed=False)
